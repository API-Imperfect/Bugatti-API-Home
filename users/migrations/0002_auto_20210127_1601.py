...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='birth_date',
            field=models.DateField(default=django.utils.timezone.now, verbose_name='Date of Birth,Year,Month,Date'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='customuser',
            name='country',
            field=django_countries.fields.CountryField(default='KE', max_length=2, verbose_name='Your country code'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='gender',
